...
class DialCodeWidget extends StatefulWidget {
  const DialCodeWidget({
    super.key,
    required this.actionPar,
  });

  final Future Function(String dialCode)? actionPar;
...
class _DialCodeWidgetState extends State<DialCodeWidget> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: EdgeInsetsDirectional.fromSTEB(16.0, 250.0, 0.0, 0.0),
      child: FutureBuilder<ApiCallResponse>(
        ...
        builder: (context, snapshot) {
          ...
          final containerCountryCodesResponse = snapshot.data!;
              ...
              child: Column(
                ...
                children: [
                        ...
                        () async {
                          safeSetState(() {
                            _model.simpleSearchResults = TextSearch(
                                    CountryCodesCall.dialCode(
                              containerCountryCodesResponse.jsonBody,
                            )!
                  ...
                  Padding(
                    ...
                    child: Builder(
                      builder: (context) {
                        final dialcodes = _model.textController.text != null &&
                        ...
                        return SingleChildScrollView(
                          child: Column(
                            mainAxisSize: MainAxisSize.max,
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: List.generate(dialcodes.length,
                                (dialcodesIndex) {
                              ...
                              return InkWell(
                                ...
                                onTap: () async {
                                  _model.dialCode = dialcodesItem;
                                  safeSetState(() {});
                                  await widget.actionPar?.call(
                                    _model.dialCode!,
                                  );
