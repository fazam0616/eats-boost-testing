...
abstract class FlutterFlowTheme {
  ...
  late Color greenFigma;
  late Color yellowFigma;
  late Color greyBGFigma;
  late Color pinkFigma;
  late Color skyBlueFIgma;
  late Color darkGrayFigma;
  late Color shineYellowFigma;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color greenFigma = Color(0xFF93E29F);
  late Color yellowFigma = Color(0xFFFFC16B);
  late Color greyBGFigma = Color(0xFFF8F8F8);
  late Color pinkFigma = Color(0xFFFFAEAE);
  late Color skyBlueFIgma = Color(0xFFB8E4FF);
  late Color darkGrayFigma = Color(0xFFF3F3F3);
  late Color shineYellowFigma = Color(0xFFFFC16B);
}
